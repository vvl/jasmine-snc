describe("SncReporter", function() {
  ...
  beforeEach(function() {
    out = (function() {
      ...
      return {
        ...
        getOutput: function() {
          return output.replace('SncReporter is deprecated and will be removed in a future version.', '');
        },
        clear: function() {
          output = "";
        }
  ...
  it("reports that the suite has started to the console", function() {
    var reporter = new j$.SncReporter({
      print: out.print
    });
